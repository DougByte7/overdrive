    ...
    useEffect(() => {
        ...
        const filterByAlignment = (monster: DnD5eMonster) => {
            return (
                ...
                monster.alignment === filters.alignment
            )
        }
        ...
        const filterByCr = (monster: DnD5eMonster) => {
            const crValue =
                monsterCr.find((s) => s.label === monster.challenge_rating)
                    ?.value ?? 0
        ...
        setFilteredMonsters(
            monsters.filter(
                (monster) =>
                    removeDiacritics(monster.name.toLowerCase()).includes(
                        search
                    ) &&
        ...
        <>
            ...
            <main>
                <Tabs defaultValue="all">
                    <Tabs.List>
                        <Tabs.Tab value="encounter" disabled>
                            Encontros
                        </Tabs.Tab>
                    ...
                    <Stack h="calc(100vh - 76px)">
                        ...
                        <Box px="sm">
                            ...
                            <RangeSlider
                                ...
                                marks={monsterSizes.slice(
                                    1,
                                    monsterSizes.length - 1
                                )}
                        ...
                        <Box px="sm">
                            ...
                            <RangeSlider
                                label={(val) =>
                                    monsterCr.find((mark) => mark.value === val)
                                        ?.label
                                }
                ...
                >
                    <Stack>
                        ...
                        <Group gap="xs">
                            <Text size="sm">
                                FOR {selectedMonster?.strength}
                            </Text>
                            <Text size="sm">
                                DES {selectedMonster?.dexterity}
                            </Text>
                            <Text size="sm">
                        ...
                        <Stack gap={0}>
                            ...
                            {!!selectedMonster?.condition_immunities.length && (
                                <Text>
                                    Imune{' '}
                                    {selectedMonster?.condition_immunities.map(
                                        (c) => c.name
                                    )}
                                </Text>
                            )}
                        ...
                        {!!selectedMonster?.legendary_actions.length && (
                            <>
                                ...
                                <Stack>
                                    {selectedMonster?.legendary_actions.map(
                                        (a) => (
                                            <Text key={a.name}>
