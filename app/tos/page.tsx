    ...
    return (
        <>
            ...
            <main className="prose lg:prose-xl prose-invert mx-auto mt-4">
                ...
                <br />
                <p>
                    These terms and conditions applies to the DiceOverdrive app
                    (hereby referred to as "Application") for mobile devices
                    that was created by Douglas Morriesen de Almeida (hereby
                    referred to as "Service Provider") as a Freemium service.
                </p>
                <br />
                <p>
                ...
                <br />
                <p>These terms and conditions are effective as of 2024-05-05</p>
                <br />
                <strong>Contact Us</strong>
                <p>
                    If you have any questions or suggestions about the Terms and
                    Conditions, please do not hesitate to contact the Service
                    Provider at dougbyte@diceoverdrive.com.
                </p>
                <hr />
                <br />
            </main>
