            ...
            <Transition mounted={!!selectedSpell} transition="slide-up">
                {(styles) => (
                    <div
                        ...
                        style={{
                            ...styles,
                            ...spellInfoStyles(verticalOffset, h),
                        }}
                    >
                        <ActionIcon
                            size="xl"
                        ...
                        <Stack align="center" gap="sm">
                            ...
                            <Group gap="xs">
                                {selectedSpell?.duration.startsWith(
                                    'Concentration'
                                ) && (
                                    <Badge
                                        color="gray"
                            ...
                            <dl className="grid grid-cols-2 gap-2 m-0 text-sm [dt]:mr-1 [dt]:font-bold [dd]:m-0">
                                <Group gap={0}>
                                    <dt>Duração: </dt>
                                ...
                                <Group gap={0}>
                                    ...
                                    <dd>
                                        {selectedSpell?.range
                                            ...
                                            .replace(
                                                /\(|(cone|hemisphere|line|cube|sphere)|\)/g,
                                                ''
                                            )
                                            .replace('-mile', ' mi')}
                                        {selectedSpell?.range.includes(
                                            'cone'
                                        ) && (
                                            <IconCone2
                                        ...
                                        {selectedSpell?.range.includes(
                                            ...
                                            <IconHemisphere
                                                className="ml-1 mb-[-2px] rotate-180"
                                                size={12}
                                            />
                                        )}
                                        {selectedSpell?.range.includes(
