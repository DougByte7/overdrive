...
const ranger: DnD5eClass = {
  ...
  proficiencies: {
    ...
    equipmentOptions: [
      [
        { name: "scaleMail", amount: 1 },
        { name: "leatherArmor", amount: 1 },
      ],
      [
        { name: "shortsword", amount: 2 },
        { name: "simpleMeleeWeapon", amount: 2 },
      ],
      [
        { name: "dungeoneersPack", amount: 1 },
        { name: "explorersPack", amount: 1 },
      ],
      [{ name: "longbow", amount: 1, ammo: 20 }],
      [{ name: "quiver", amount: 1 }],
    ],
  },
}
