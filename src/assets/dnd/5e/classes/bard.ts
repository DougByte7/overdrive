...
const bard: DnD5eClass = {
    ...
    equipmentOptions: [
        [
            [{ item: 'rapier', amount: 1 }],
            [{ item: 'longsword', amount: 1 }],
            [{ item: 'Simple', amount: 1 }],
        ],
        [
            [{ item: 'diplomats-pack', amount: 1 }],
            [{ item: 'entertainers-pack', amount: 1 }],
        ],
        [[{ item: 'Musical Instrument', amount: 1 }]],
        [[{ item: 'leather-armor', amount: 1 }]],
        [[{ item: 'dagger', amount: 1 }]],
    ],
}
